...
import { ActivityIndicator, ScrollView, StyleSheet, Text, TouchableOpacity, View } from "react-native"; // Adicionei ScrollView
...
    padding: 20,
    paddingTop: 0, // Removido o padding de cima
  },
  loadingContainer: {
    flex: 1,
