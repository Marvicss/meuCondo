          ...
          return (
            <Card key={v.id} style={{ backgroundColor: theme.colors.surface, marginBottom: 16 }}>
              <Card.Title
                ...
                subtitle={`Período de votação: ${new Date(v.startDate).toLocaleDateString(
                  'pt-BR'
                ...
                <View style={{ marginBottom: 8 }}>
                  <View style={styles.rowBetween}>
                    ...
                    <Text style={{ color: theme.colors.onSurfaceVariant }}>
                      {String(v.yesCount).padStart(2, '0')}
                    </Text>
                  </View>
                  <ProgressBar
                    progress={yesPct(v)}
      ...
      <Portal>
        ...
        >
          <ScrollView>
            ...
            {showStartPicker && (
              <DateTimePicker mode="date" display="default" value={startDate} onChange={onChangeStart} />
            )}
