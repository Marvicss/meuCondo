  ...
  <View style={styles.cardContainer}>
    ...
    <View style={styles.cardContent}>
      ...
      <View style={styles.cardActions}>
        <TouchableOpacity style={[styles.cardButton, styles.editButton]} onPress={() => onEdit(item)}>
          <SvgXml xml={Icones.edit} width="16" height="16" />
          <Text style={styles.cardButtonText}>Editar</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.cardButton, styles.removeButton]} onPress={() => onRemove(item.id)}>
    ...
    useCallback(() => {
      const fetchAvisos = async () => {
        ...
        try {
          ...
          if (!token) {
            Alert.alert("Autenticação Necessária", "Por favor, faça o login para continuar.");
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.novoAvisoButton} onPress={() => router.push('/notice-sindico/adicionar-aviso')}>
        ...
        <FlatList
          data={avisos}
          renderItem={({ item }) => <AvisoCard item={item} onEdit={handleEdit} onRemove={handleRemove} />}
